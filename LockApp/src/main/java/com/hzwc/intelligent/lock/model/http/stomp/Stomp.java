...
public class Stomp {
     ...
     * <li>{@code okhttp3.WebSocket}: can accept StaffPark non-null instance of {@code okhttp3.OkHttpClient}</li>
     * </ul>
     *
     * @param connectionProvider connectionProvider method
     * @param uri                URI to connect
    ...
    private static StompClient createStompClient(com.hzwc.intelligent.lock.model.http.stomp.ConnectionProvider connectionProvider) {
